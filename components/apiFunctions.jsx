...
const get_from_api_files_no_cache = async function (url, request) {
  const API_URL = await process.env.NEXT_PUBLIC_API_URL;
  return await fetch(API_URL + url, {
      method: "GET",
      headers: {
...
export default { post_to_api, get_from_api, post_to_api_token, get_from_api_token, post_to_api_token_files, get_from_api_files, get_from_api_files_no_cache };